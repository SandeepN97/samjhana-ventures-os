...
export default function EVManualEntryPage() {
  ...
  useEffect(() => {
    ...
    // The NEA rate is business-sensitive: only admins/managers load it (the API refuses staff),
    // and a rate cached in this browser by an earlier admin session must never reach staff.
    if (!canEditNeaRate) return;
